...
class History extends Component {
  state = {updatedList: initialHistoryList, searchValue: ''}
  ...
  deleteIconD = id => {
    ...
    const filterList = updatedList.filter(each => each.id !== id)
  ...
  render() {
    ...
    if (updatedList.length === 0 || searchValue !== '') {
      return (
        <div className="bgContainer">
          ...
          <p className="emptyContainer">There is no history to show</p>
        </div>
      )
    }
    return (
